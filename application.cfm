<cfapplication name="sidewalk_viewer" clientmanagement="Yes" sessionmanagement="Yes" sessiontimeout="#Createtimespan(0,8,0,0)#" applicationtimeout="#Createtimespan(1,0,0,0)#">
...
<cfset request.url="http://78boe99prod/sidewalk_viewer/">
...
<cfif request.production eq 1>
	<cfset request.dir="d:\sidewalk_viewer">
